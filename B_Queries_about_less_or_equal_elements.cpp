...
void solve(){
   ...
   all(v1);
    f0(i, 0, n){
        if (lb(v1.begin(), v1.end(), v2[i])==v1.end())
        {
            cout<<m<<" ";
        }
        else  if (lb(v1.begin(), v1.end(), v2[i])==ub(v1.begin(), v1.end(), v2[i])){
            cout<<lb(v1.begin(), v1.end(), v2[i])-v1.begin()+m_p[v2[i]]-1+1<<" ";
        }
        else{
            cout<<lb(v1.begin(), v1.end(), v2[i])-v1.begin()+1+m_p[v2[i]]-1<<" ";
        }
